...
import { FeedCardSkeletons, FeedEmpty, FeedError, FeedMasthead, FeedTail, FireCard, FireCardList } from '../components';
import type { CommunityNewsViewProps } from './CommunityFirePage.types';
import { Sentinel } from './CommunityFirePage.styled';

const n = COMMUNITY_COPY.fire;

/** 갤러리·게시판과 같은 낱말을 써서 세 목록이 한 축(커뮤니티)임을 말한다. */
const MASTHEAD_EYEBROW = '커뮤니티';

/**
 * `/community/firenow` — 미디어 뉴스 목록.
 *
