...
import { getSupabaseClient, publishPost, type NewsPayload } from '@/shared/lib/supabase';
 ...
 * 적기 시작한다 — 그건 우리가 하려는 일이 아니다(저작권 · NewsPayload 주석).
 *
 * ## 실패해도 막다른 길이 아니다
...
export const useLinkShare = (copy: {
  ...
  const [preview, setPreview] = useState<NewsPayload | null>(null);
