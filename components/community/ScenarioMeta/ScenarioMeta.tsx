...
import type { ScenarioMetaProps } from './ScenarioMeta.types';
import { MetaItem, MetaRow, VisuallyHidden } from './ScenarioMeta.styled';
 ...
 */
export default function ScenarioMeta({ viewCount, likeCount, commentCount, hideViews }: ScenarioMetaProps) {
  return (
    <MetaRow>
      <MetaItem>
        <HeartIcon size={14} />
